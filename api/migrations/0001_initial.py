    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('topwear', 'Top Wear'), ('bottomwear', 'Bottom Wear'), ('hats', 'Hats'), ('footwear', 'Footwear'), ('accessories', 'Accessories'), ('gadgets', 'Gadgets')], max_length=50)),
